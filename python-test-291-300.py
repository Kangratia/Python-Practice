...
#005380
#035420
f = open("C:\\Users\\Karl Lee\\Desktop\\매수종목1.txt", mode="wt", encoding = "utf-8")
f.write("005930\n")
f.write("005380\n")
f.write("035420")
f.close()
...
f = open("C:\\Users\\Karl Lee\\Desktop\\매수종목2.txt", mode="wt", encoding = "utf-8")
f.write("005930 삼성전자\n")
f.write("005380 현대차\n")
...
# 293 CSV 파일 쓰기
import csv
f = open("C:\\Users\\Karl Lee\\Desktop\\매수종목.csv", mode="wt", encoding = "cp949", newline = '')
writer = csv.writer(f)
...
# 005380
# 035420
f = open("C:\\Users\\Karl Lee\\Desktop\\매수종목1.txt", encoding="utf-8")
...
f = open("C:\\Users\\Karl Lee\\Desktop\\매수종목2.txt", encoding="utf-8")
lines = f.readlines()
